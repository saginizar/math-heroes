...
export const WORLDS = {
  ...
  web_tower: {
    ...
    levels: [
      { id: 1, nameHe: 'טיפוס ראשון', type: 'PowerLaunch', difficulty: 2, operation: 'subtraction', problemCount: 3, reward: 'web_boots', missionKey: '2-1' },
      { id: 2, nameHe: 'מגן הקורים', type: 'ShieldMatch', difficulty: 2, operation: 'addition', problemCount: 3, reward: 'web_gloves', missionKey: '2-2' },
      { id: 3, nameHe: 'שלושה מסלולים', type: 'PathChooser', difficulty: 2, operation: 'subtraction', problemCount: 3, reward: 'web_belt', missionKey: '2-3' },
  ...
  iron_lab: {
    ...
    levels: [
      { id: 1, nameHe: 'ניסוי ראשון', type: 'PowerLaunch', difficulty: 2, operation: 'multiplication', problemCount: 3, reward: 'iron_boots', missionKey: '3-1' },
      { id: 2, nameHe: 'שלושת הנתיבים', type: 'PathChooser', difficulty: 2, operation: 'multiplication', problemCount: 3, reward: 'iron_gloves', missionKey: '3-2' },
  ...
  mushroom_quest: {
    ...
    levels: [
      { id: 1, nameHe: 'מסע הפטריות', type: 'PowerLaunch', difficulty: 2, operation: 'division', problemCount: 3, reward: 'mushroom_boots', missionKey: '4-1' },
      ...
      { id: 3, nameHe: 'דרך ביער', type: 'PathChooser', difficulty: 2, operation: 'division', problemCount: 3, reward: 'mushroom_belt', missionKey: '4-3' },
  ...
  grand_circuit: {
    ...
    levels: [
      { id: 1, nameHe: 'זינוק במסלול', type: 'PowerLaunch', difficulty: 3, operation: 'addition', problemCount: 3, reward: 'race_boots', missionKey: '5-1' },
      { id: 2, nameHe: 'מסלול הבחירה', type: 'PathChooser', difficulty: 2, operation: 'subtraction', problemCount: 3, reward: 'race_gloves', missionKey: '5-2' },
      { id: 3, nameHe: 'מגן המרוץ', type: 'ShieldMatch', difficulty: 3, operation: 'addition', problemCount: 3, reward: 'race_belt', missionKey: '5-3' },
  ...
  dr_zero_lair: {
    ...
    levels: [
      { id: 1, nameHe: 'כניסה למאורה', type: 'PowerLaunch', difficulty: 3, operation: 'division', problemCount: 3, reward: 'zero_boots', missionKey: '6-1' },
      { id: 2, nameHe: 'מגן האפס', type: 'ShieldMatch', difficulty: 4, operation: 'addition', problemCount: 3, reward: 'zero_gloves', missionKey: '6-2' },
      { id: 3, nameHe: 'שלושה מבחנים', type: 'PathChooser', difficulty: 3, operation: 'multiplication', problemCount: 3, reward: 'zero_belt', missionKey: '6-3' },
